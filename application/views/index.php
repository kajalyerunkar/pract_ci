...
<head>
    ...
    <script type="text/javascript">
      ...
      curl = "<?php echo base_url()?>index.php/project/";
    </script>
    ...
    <link href="<?php echo css();?>price-range.css" rel="stylesheet">
...
<body>
          ...
          <div class="left-sidebar">
            ...
            <div class="brands_products"><!--brands_products-->
              ...
              <div class="brands-name">
                <ul class="nav nav-pills nav-stacked brands_data">
  ...
  <script src="<?php echo js();?>price-range.js"></script>
